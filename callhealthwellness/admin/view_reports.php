            ...
            <div class="row">
                ...
                <div class="col-xs-10">
                    ...
                    <table class="table-striped reportstab">
                    	...
                    	?> 
                    	<tr><td style="margin-top: 25px"> <?php echo $row['fname']; ?></td><td> <?php echo $row['lname']; ?></td><td> <?php echo $row['mobileNo']; ?></td><td> <?php echo $row['emailid']; ?></td> <td> <?php echo $row['empid']; ?></td> <td> <?php echo $row['age']; ?></td>  <td> <?php echo $row['gender']; ?></td><td> <?php echo $row['address']; ?></td><td> <?php echo $row['pincode']; ?></td> <td> <?php echo $row['program']; ?></td>  <td> <?php echo $row['registerOn']; ?></td> <td> <?php echo $row['branchName']; ?></td>  <td> <?php echo $row['empRel']; ?></td><td> <?php echo $row['relation']; ?></td>	 <td> <?php echo $row['registerId'] ?> </td> <td> <?php echo $row['id'] ?> </td> <td> <a href="delete_report.php?id=<?php echo $row['id']; ?>" > Delete </a> </td></tr>
                    	<?php }
                    	}else{
